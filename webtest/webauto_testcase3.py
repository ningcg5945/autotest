...
class Search(unittest.TestCase):
    ...
    def test_readSQLcase1(self):  # 流程的相关接口
        sql = "SELECT id, webfindmethod, webevelement, weboptmethod, webtestdata, webassertdata, `webtestresult` from " \
...
if __name__ == '__main__':
    ...
    filename = "D:\\Program Files\\Python36-32\\Scripts\\autotest\\webtest\\templates\\" + 'webtest_report' + '{}'.format(
        nowTime) + '.html'
    fp = open(filename, 'wb')
