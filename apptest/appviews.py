...
def appcase_manage(request):
    ...
    return render(request, "appcase_manage.html",
                  {"user": username, "appcases": appcase_list, "appcasecounts": appcase_count})  # 把值赋给apitestcounts这个变量
...
def appcasestep_manage(request):
    ...
    return render(request, "appcasestep_manage.html",
                  {"user": username, "appcase": appcase, "appcasesteps": appcasestep_list})  # 把值赋给apitestcounts这个变量
